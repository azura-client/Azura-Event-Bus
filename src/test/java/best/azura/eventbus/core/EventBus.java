...
public class EventBus {
     ...
     * */
    public boolean isValidMethod(final Method method, final Class<?> methodClass) {
        for (final Class<?> parameter : method.getParameterTypes()) if (methodClass == parameter
                && method.getParameterCount() == 1) return true;
        return false;
    }
